...
def train_val_test_split(kfold=5, fold=0, num=0):
    id = list(range(num))
    ...
    kf = KFold(n_splits=kfold, random_state=666, shuffle=True)
    kf2 = KFold(n_splits=kfold - 1, shuffle=True, random_state=333) #999
